...
describe("NotionClientWrapper", () => {
    ...
    test("should call appendBlockChildren with correct parameters", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(`https://api.notion.com/v1/blocks/${blockId}/children`, {
            method: "PATCH",
    ...
    test("should call retrieveBlock with correct parameters", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(`https://api.notion.com/v1/blocks/${blockId}`, {
            method: "GET",
            headers: wrapper.headers,
        });
    });
    test("should call retrieveBlockChildren with pagination parameters", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(`https://api.notion.com/v1/blocks/${blockId}/children?start_cursor=${startCursor}&page_size=${pageSize}`, {
            method: "GET",
            headers: wrapper.headers,
        });
    });
    ...
    test("should call queryDatabase with correct parameters", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith(`https://api.notion.com/v1/databases/${databaseId}/query`, {
            method: "POST",
            headers: wrapper.headers,
    ...
    test("should call search with correct parameters", async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith("https://api.notion.com/v1/search", {
            method: "POST",
            headers: wrapper.headers,
